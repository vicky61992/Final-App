...
elo_df <- read.csv("https://raw.githubusercontent.com/vicky61992/Final-App/master/FileA.csv")
df <- read.csv("https://raw.githubusercontent.com/vicky61992/Final-App/master/FileB.csv")
